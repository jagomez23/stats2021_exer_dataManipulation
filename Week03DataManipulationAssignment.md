...
-   List each variable and the level of measurement. Note if there are
    ...
    -   research – nominal
    -   height – continuous-decimal
    -   weight – continuous-decimal
    -   lvst1 – ordinal- Integer
    -   lvst2 – ordinal- Integer
    -   lvst3- ordinal- Integer
    -   lvst4- ordinal- Integer
    -   frst1- ordinal- Integer
    -   frst2- ordinal- Integer
    -   frst3- ordinal- Integer
